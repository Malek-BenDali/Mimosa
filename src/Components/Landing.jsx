...
export default function () {
	...
	return (
		<>
			<div ref={targetRef} className="w-full linear h-[100vh] p-[2%]">
				<div className="flex  items-center font-semibold text-6xl text-white">
					<svg
						className="h-20 w-20"
						viewBox="0 0 560 499"
						fill="none"
				...
				<p className=" text-white text-3xl">
					Forces ranging from heart <br /> beat to personc scale
				</p>
			</div>
		</>
	)
